...
/* Keep the fixed Service/Generator result boxes symmetrical without observing the managed count. */
(function(){
  'use strict';
...
/* Main Site button is already permanent in index.html; this is a no-op fallback. */
(function(){
  'use strict';
