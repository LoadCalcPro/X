...
Cooking rows group appliances of the same rating for entry and show connected VA. The calculator applies Table 220.55 once to all completed cooking-appliance rows and recalculates the combined demand after every entry, change, addition or removal. Columns A/B are applied where the combined group is within Note 3; Column C otherwise, with the over-12-kW adjustment. Ratings at or below 1.75 kW and above 27 kW stay at nameplate. No branch-circuit combination shortcut is used for separate ovens/cooktops.
