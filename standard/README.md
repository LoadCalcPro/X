...
Cooking rows group appliances of the same rating for entry and show connected VA. The calculator separates completed entries into the applicable Table 220.55 groups: ranges over 8.75 kW through 27 kW use Column C and Notes 1/2; appliances over 1.75 kW but under 3.5 kW use Column A; appliances from 3.5 kW through 8.75 kW use Column B. The group results are added and recalculated after every entry, change, addition or removal. Ratings at or below 1.75 kW and above 27 kW stay at nameplate. No branch-circuit combination shortcut is used for separate ovens/cooktops.
