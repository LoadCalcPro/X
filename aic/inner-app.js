...
const ACCESS_API_URL = 'https://loadcalcpro-hcml-api.onrender.com/api/access';
const ACCESS_SESSION_KEY = 'loadCalcProAicAccessApproved';
const REMEMBERED_EMAIL_KEY = 'loadCalcProRememberedMemberEmail';
const DASHBOARD_URL = 'member-dashboard.html';
const SUPABASE_URL = 'https://oaqehddiqtgplxydxbxv.supabase.co';
const SUPABASE_PUBLISHABLE_KEY = 'sb_publishable_o_3xMc9QOsgV-8kqBFkLnw_tuvUyWD8';
const API_BASE_URL = 'https://loadcalcpro-hcml-api.onrender.com';
